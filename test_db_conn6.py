"""Quick DB test - with pgbouncer compatible settings."""
import os, sys, time
sys.path.insert(0, '.')
...
print("Connecting with pgbouncer mode...", flush=True)
t0 = time.time()
try:
    conn = psycopg2.connect(DB_URL, connect_timeout=30, prepare_threshold=0)
