...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('bt_output_v6.log', encoding='utf-8'),
...
print(f'Running backtest v6 ({bt_cfg.start_date} ~ {bt_cfg.end_date})...', flush=True)
...
try:
    ...
    if result:
        with open('bt_result_v6.txt', 'w', encoding='utf-8') as f:
            f.write(result['summary'])
        if result['trades']:
            with open('bt_trades_v6.json', 'w', encoding='utf-8') as f:
