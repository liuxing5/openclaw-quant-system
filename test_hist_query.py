...
cur.execute("""
    ...
    ORDER BY pct_chg DESC LIMIT 50
""", (trade_date,))
...
print(f"获取active_codes: {time.time()-t0:.2f}s, {len(active_codes)}只")
...
# 检查000026
if '000026.SZ' in active_codes:
    print("000026.SZ 在active_codes中!")
else:
    print("000026.SZ 不在active_codes中")
